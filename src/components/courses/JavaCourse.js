...
<section id="skills" className="skills-gained">
  ...
  <ul>
    ...
    <li>Working with Classes, Objects, and Inheritance</li>
    <li>Data Structures and Algorithms in Java</li>
    <li>Building and Handling Java Threads for Multithreading</li>
    <li>Working with Java Collections (List, Set, Map, etc.)</li>
    <li>Developing Java-based RESTful APIs</li>
    <li>Using Spring Framework for Dependency Injection and MVC</li>
    <li>Performance Optimization Techniques in Java</li>
    <li>Testing and Debugging Java Applications (JUnit, Mockito)</li>
    <li>Version Control with Git and GitHub</li>
    <li>Implementing Design Patterns in Java</li>
    <li>Deploying Java Applications on Servers</li>
  </ul>
</section>
