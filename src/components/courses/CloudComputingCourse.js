...
import './CloudComputingCourse.css';
...
<section id="skills" className="skills-gained">
  ...
  <ul>
    <li>Cloud Infrastructure and Architecture Design</li>
    <li>Understanding and Utilizing Cloud Service Models (IaaS, PaaS, SaaS)</li>
    <li>Deploying and Managing Virtual Machines and Containers</li>
    <li>Cloud Security Best Practices</li>
    <li>Using Cloud Platforms (AWS, Azure, Google Cloud)</li>
    <li>Scalability and Performance Optimization in Cloud Environments</li>
    <li>Networking in the Cloud (VPC, Subnets, Load Balancing)</li>
    <li>Version Control with Git and GitHub</li>
    <li>Automating Infrastructure with Infrastructure as Code (Terraform, CloudFormation)</li>
    <li>Deploying and Monitoring Cloud Applications in Production</li>
  </ul>
</section>
...
<section id="mentor-demo" className="mentor-demo-section">
  ...
  <div className="mentor-box">
    ...
    <div className="mentor-info">
      <h3>Jane Smith</h3>
      <p>Jane Smith is a seasoned cloud architect with extensive expertise in designing and deploying cloud infrastructure. She has over 12 years of industry experience and has guided countless professionals in mastering cloud technologies.</p>
    </div>
  </div>
</section>
