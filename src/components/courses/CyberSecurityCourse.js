...
import './CyberSecurityCourse.css';
...
<section id="skills" className="skills-gained">
  ...
  <ul>
    ...
    <li>Encryption and Cryptography Techniques</li>
    <li>Understanding Firewalls and Intrusion Detection Systems (IDS)</li>
    <li>Incident Response and Disaster Recovery Planning</li>
    <li>Penetration Testing and Ethical Hacking</li>
    <li>Version Control with Git and GitHub</li>
    <li>Implementing Secure Coding Practices</li>
    <li>Deploying and Managing Secure Applications</li>
  </ul>
</section>
...
<section id="mentor-demo" className="mentor-demo-section">
  ...
  <div className="mentor-box">
    ...
    <div className="mentor-info">
        <h3>Alex Johnson</h3>
        <p>Alex Johnson is a seasoned Cyber Security expert with extensive experience in network security and threat analysis. With over 10 years in the field, he has guided numerous organizations in safeguarding their digital assets and has educated countless professionals in Cyber Security best practices.</p>
    </div>
  </div>
</section>
