...
<section id="mentor-demo" className="mentor-demo-section">
  ...
  <div className="mentor-box">
    ...
    <div className="mentor-info">
      <h3>Dr. Ethan Carter</h3>
      <p>Dr. Ethan Carter is a renowned blockchain expert and researcher with a deep understanding of distributed systems and cryptography. With extensive academic and industry experience, he has contributed significantly to the advancement of blockchain technology. Dr. Carter is passionate about sharing his knowledge and empowering others to build innovative blockchain solutions.</p>
    </div>
  </div>
</section>
