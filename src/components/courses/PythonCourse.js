...
<section id="mentor-demo" className="mentor-demo-section">
  ...
  <div className="mentor-box">
    ...
    <div className="mentor-info">
        <h3>Perry</h3>
        <p>Perry is a seasoned Python developer and data scientist with over a decade of experience in applying Python to solve complex problems. He has a deep understanding of Python's ecosystem and has taught numerous individuals and teams to harness the power of Python.</p>
    </div>
  </div>
</section>
    ...
    <div className="curriculum-column">
      <ul className="curriculum-list">
        ...
        <li data-subtopics="Project Setup,Development Workflow,Deployment and Optimization">
          ...
          <div className="module-content">Python Project</div>
        </li>
      </ul>
    </div>
