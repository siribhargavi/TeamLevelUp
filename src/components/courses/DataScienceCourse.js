...
const DataScienceCourse = () => {
 ...
 <section class="video-learning">
  ...
  <ul>
    ...
    <li>Web Development with Python (Django or Flask)</li>
    <li>Database Interaction (SQL, NoSQL)</li>
    <li>Python for Data Engineering (Spark, Hadoop)</li>
    <li>Advanced Python Topics (functional programming, metaprogramming)</li>
  </ul>
</section>
  ...
  <div className="curriculum-content">
    <div className="curriculum-column">
      <ul className="curriculum-list">
        <li data-subtopics="Introduction to Python, Setting Up the Environment, Basics of Programming">
          <div className="module-title">Module 1:</div>
          <div className="module-content">Python Fundamentals</div>
        </li>
        <li data-subtopics="Control Structures, Functions, Modules">
          <div className="module-title">Module 2:</div>
          <div className="module-content">Python Programming Constructs</div>
        </li>
        <li data-subtopics="Classes, Objects, Inheritance, Polymorphism">
          <div className="module-title">Module 3:</div>
          <div className="module-content">Object-Oriented Python</div>
        </li>
        <li data-subtopics="Lists, Dictionaries, Sets, Tuples">
          <div className="module-title">Module 4:</div>
          <div className="module-content">Data Structures in Python</div>
        </li>
        <li data-subtopics="File Handling, Exception Handling">
          <div className="module-title">Module 5:</div>
          <div className="module-content">File and Exception Handling</div>
        </li>
      </ul>
    </div>
    <div className="curriculum-column">
      <ul className="curriculum-list">
        <li data-subtopics="Regular Expressions, String Manipulation">
          <div className="module-title">Module 6:</div>
          <div className="module-content">Text Manipulation and Regular Expressions</div>
        </li>
        <li data-subtopics="NumPy, Pandas, Data Cleaning, Data Transformation">
          <div className="module-title">Module 7:</div>
          <div className="module-content">Data Analysis with Python</div>
        </li>
        <li data-subtopics="Matplotlib, Seaborn, Plotly, Data Visualization Techniques">
          <div className="module-title">Module 8:</div>
          <div className="module-content">Data Visualization</div>
        </li>
        <li data-subtopics="Introduction to Machine Learning, Supervised Learning, Unsupervised Learning">
          <div className="module-title">Module 9:</div>
          <div className="module-content">Introduction to Machine Learning</div>
        </li>
        <li data-subtopics="End-to-End Project, Data Collection, Model Building, Deployment">
